 ...
 * when the fast pointer reaches the end, the slow pointer will be n+1 places behind - just the right
 * spot for it to be able to skip the next node.
...
public class RemoveNthFromEnd1 {
	...
	public static void main(String[]args){
		//new RemoveNthFromEnd1().removeNthFromEnd(head, n)
